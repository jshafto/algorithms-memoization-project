...
function minChange(coins, amount, memo = {}) {
    ...
    coins.forEach((coin) => {
        if (coin <= amount) {
            let pathVal = 1 + minChange(coins, amount - coin, memo);
            if (pathVal < bestPath) bestPath = pathVal;
        }
    })
    //console.log(memo, bestPath);
...
//             let pathVal = 1 + minChange(coins, amount - coin, memo);
//             // if (pathVal <= bestPath) bestPath = pathVal;
//             bestPath.push(pathVal);

//         }
//     })
//     //console.log(memo, bestPath);
//     memo[amount] = Math.min(...bestPath);
//     return memo[amount];
// }
